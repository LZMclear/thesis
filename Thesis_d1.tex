...
% 英文封面内容
\englishtitle{英文题目英文题目英文题目英文题目英文题目}
\englishauthor{\emph{Zhang Xiaosi}}
\englishadvisor{Prof. Wang Wuwu}
\englishdate{May, 2021}
...
\include{chapters/DeclareOriginal}
%\include{chapters/DeclareOriginal}
