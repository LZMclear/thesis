"""
仿真图2：理想与非理想硬件条件下不同网络规模的用户可达速率图
使用符合文献的静态数据，添加训练波动
...
plt.tight_layout()
plt.savefig('e:\\Gvto\\桌面\\thesis\\fig2_ideal_vs_nonideal.png', dpi=300, bbox_inches='tight')
plt.savefig('e:\\Gvto\\桌面\\thesis\\fig2_ideal_vs_nonideal.pdf', bbox_inches='tight')
plt.show()

print("图2已保存: fig2_ideal_vs_nonideal.png/pdf")
print(f"\n性能损失统计:")
